...
const mockTracks: Track[] = [
  {
    ...
    genre: 'Synthwave',
    stems: [
      { id: 's1', name: 'Drums', color: '#ef4444', frequency: 60, waveform: 'sawtooth' },
      { id: 's2', name: 'Bass', color: '#f97316', frequency: 110, waveform: 'sawtooth' },
      { id: 's3', name: 'Synth Pad', color: '#22c55e', frequency: 261.63, waveform: 'sine' },
      { id: 's4', name: 'Arpeggio', color: '#3b82f6', frequency: 392, waveform: 'triangle' },
      { id: 's5', name: 'Lead', color: '#a855f7', frequency: 523.25, waveform: 'sawtooth' },
    ],
  },
  {
    id: '2',
    ...
    genre: 'Blues',
    stems: [
      { id: 's6', name: 'Drums', color: '#ef4444', frequency: 55, waveform: 'sawtooth' },
      ...
      { id: 's9', name: 'Lead Guitar', color: '#14b8a6', frequency: 329.63, waveform: 'sawtooth' },
      { id: 's10', name: 'Vocals', color: '#a855f7', frequency: 440, waveform: 'sine' },
      { id: 's11', name: 'Piano', color: '#3b82f6', frequency: 261.63, waveform: 'triangle' },
    ],
  },
  {
    id: '3',
    ...
    genre: 'Techno',
    stems: [
      { id: 's12', name: 'Kick', color: '#ef4444', frequency: 50, waveform: 'sawtooth' },
      { id: 's13', name: 'Bass', color: '#f97316', frequency: 73.42, waveform: 'sawtooth' },
      { id: 's14', name: 'Synth', color: '#22c55e', frequency: 220, waveform: 'sawtooth' },
      { id: 's15', name: 'Percussion', color: '#3b82f6', frequency: 1000, waveform: 'triangle' },
      { id: 's16', name: 'FX', color: '#a855f7', frequency: 800, waveform: 'sawtooth' },
    ],
  },
  {
    id: '4',
    ...
    genre: 'Funk',
    stems: [
      { id: 's17', name: 'Drums', color: '#ef4444', frequency: 65, waveform: 'sawtooth' },
      { id: 's18', name: 'Bass', color: '#f97316', frequency: 98, waveform: 'sawtooth' },
      { id: 's19', name: 'Guitar', color: '#22c55e', frequency: 196, waveform: 'triangle' },
      { id: 's20', name: 'Keys', color: '#3b82f6', frequency: 392, waveform: 'triangle' },
      { id: 's21', name: 'Horns', color: '#a855f7', frequency: 466.16, waveform: 'sawtooth' },
      { id: 's22', name: 'Vocals', color: '#ec4899', frequency: 587.33, waveform: 'sine' },
    ],
  },
  {
    id: '5',
    ...
    genre: 'Folk',
    stems: [
      { id: 's23', name: 'Acoustic Guitar', color: '#22c55e', frequency: 261.63, waveform: 'triangle' },
      { id: 's24', name: 'Vocals', color: '#a855f7', frequency: 392, waveform: 'sine' },
      { id: 's25', name: 'Bass', color: '#f97316', frequency: 130.81, waveform: 'sine' },
      { id: 's26', name: 'Percussion', color: '#ef4444', frequency: 200, waveform: 'triangle' },
      { id: 's27', name: 'Strings', color: '#3b82f6', frequency: 523.25, waveform: 'sine' },
    ],
  },
  {
    id: '6',
    ...
    genre: 'Hip-Hop',
    stems: [
      { id: 's28', name: 'Drums', color: '#ef4444', frequency: 55, waveform: 'sawtooth' },
      { id: 's29', name: '808 Bass', color: '#f97316', frequency: 73.42, waveform: 'sawtooth' },
      { id: 's30', name: 'Sample', color: '#22c55e', frequency: 261.63, waveform: 'triangle' },
      { id: 's31', name: 'Keys', color: '#3b82f6', frequency: 329.63, waveform: 'sine' },
      { id: 's32', name: 'Vocals', color: '#a855f7', frequency: 440, waveform: 'sawtooth' },
    ],
  },
  {
    id: '7',
    ...
    genre: 'Ambient',
    stems: [
      { id: 's33', name: 'Pad', color: '#22c55e', frequency: 174.61, waveform: 'sine' },
      { id: 's34', name: 'Texture', color: '#3b82f6', frequency: 349.23, waveform: 'sine' },
      { id: 's35', name: 'Bass Drone', color: '#f97316', frequency: 87.31, waveform: 'sine' },
      { id: 's36', name: 'Melody', color: '#a855f7', frequency: 698.46, waveform: 'triangle' },
    ],
  },
]
